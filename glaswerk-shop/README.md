...
Webshop voor handgeblazen en klassiek glaswerk. Next.js App Router +
TypeScript + Tailwind CSS v4 + shadcn/ui-conventie, gekoppeld aan Shopify
via de Storefront API.
...
Figma-file: **nog niet gekoppeld** — er is nog geen file-URL gedeeld met
deze omgeving. Zodra die er is, komt de link hier te staan en worden de
design-tokens in `app/globals.css` vervangen door de Figma-variabelen.
Zie `DECISIONS.md` voor alle aannames die tot die tijd gelden.
